...
# ---- GENTLE-TAIL CONTINUATION of bcrnnTxCos_nc3 ----
...
ORIG=/coc/flash7/paphiwetsa3/projects/EgoVerse2/logs/bcrnnTxCos_nc3/bc_rnn_tx_cos_2026-06-05_17-00-36
INIT_CKPT=$ORIG/checkpoints/epoch_epoch=1499.ckpt
NORM=$ORIG/norm_stats/norm_stats.json

NAME=bcrnnTxCos_nc3_cont
DESC=bc_rnn_tx_cos_cont
