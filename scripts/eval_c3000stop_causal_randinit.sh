#!/bin/bash
#SBATCH --job-name=evalC3000StopRI
...
CKPT=${RUNDIR}/checkpoints/eval_snapshot_stop_lastest.ckpt
NORM=${RUNDIR}/norm_stats/norm_stats.json
DS=/coc/flash7/paphiwetsa3/datasets/circle_3000

export ROLLOUT_VIDEO_DIR=${RUNDIR}/eval/video_randinit_thr95_stop_ep599
...
srun python -m egomimic.trainHydra \
  ...
  name=evalC3000StopRI description=eval_c3000stop_causal_chunkol_k32_randinit_ep599 mode=eval \
