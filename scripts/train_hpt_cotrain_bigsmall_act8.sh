#!/bin/bash
#SBATCH --job-name=hptCotrainBigSmallAct8
...
#SBATCH --requeue
#SBATCH --output=/coc/flash7/paphiwetsa3/projects/EgoVerse2/logs/sbatch/hptcotrain_%x_%j.out
#SBATCH --error=/coc/flash7/paphiwetsa3/projects/EgoVerse2/logs/sbatch/hptcotrain_%x_%j.err
set -uxo pipefail
...
NAME=hptCotrainBigSmallAct8
DS=/coc/flash7/paphiwetsa3/datasets/circle_3000_plus_small_circle_3000

# requeue-safe resume: on preemption SLURM re-runs this script; pick up newest last.ckpt
RESUME=""
...
srun python -m egomimic.trainHydra \
  ...
  name=${NAME} description=hpt_flow_cotrain_big_small_3000_causal_obs1_act8 mode=train \
  ...
  norm_stats.precomputed_norm_path=/coc/flash7/paphiwetsa3/projects/EgoVerse2/external_ckpts/cotrain_bigsmall_3000_norm_stats.json \
