...
# ---- CONT-2x of bcrnnTxC8FH_nc3 (weights-only init + fresh productive warmup-cosine) ----
INIT_CKPT=/coc/flash7/paphiwetsa3/projects/EgoVerse2/logs/bcrnnTxC8FH_nc3/bc_rnn_tx_chunk8_fullhist_2026-06-07_15-39-53/checkpoints/epoch_epoch=1699.ckpt
NORM=/coc/flash7/paphiwetsa3/projects/EgoVerse2/logs/bcrnnTxC8FH_nc3/bc_rnn_tx_chunk8_fullhist_2026-06-07_15-39-53/norm_stats/norm_stats.json
NAME=bcrnnTxC8FH_nc3_cont2x
DESC=bc_rnn_tx_chunk8_fullhist_cont2x
EPOCHS=${EPOCHS:-1800}; VALEVERY=100; LTB=50; MAXSTEPS=400
MAXSTEPS_SCHED=$(( EPOCHS * LTB ))   # fresh cosine horizon = new epochs x LTB
EXTRA_ARGS=""   # per-run hydra overrides (rnn_horizon / window_anchor)
