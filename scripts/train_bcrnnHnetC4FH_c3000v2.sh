...
# bcrnnHnetC4FH_c3000v2: FRESH full-history circle_3000 run. Cloned from the original
...
SMOKE=${SMOKE:-0}
NAME=${NAME:-bcrnnHnetC4FH_c3000v2}
DESC=${DESC:-bc_rnn_hnet_chunk4_fullhist_c3000}
if [ "$SMOKE" = "1" ]; then
  NAME=bcrnnHnetC4FH_c3000v2_smoke; EPOCHS=2; VALEVERY=2; LTB=6; LOGGER=csv; MAXSTEPS=20; SEEDS="evaluator.init_seeds=[0,1]"; export WANDB_MODE=disabled
else
