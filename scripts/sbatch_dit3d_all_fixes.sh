...
#SBATCH --time=8:00:00
#SBATCH --no-requeue
#SBATCH --output=/coc/flash7/paphiwetsa3/projects/EgoVerse-pact/logs/sbatch/dit3d_all_%j.out
#SBATCH --error=/coc/flash7/paphiwetsa3/projects/EgoVerse-pact/logs/sbatch/dit3d_all_%j.err
...
srun --kill-on-bad-exit=1 .venv/bin/python -m egomimic.trainHydra \
  ...
  name=dit3d_all_fixes description=dit3d_nopad_uniform_addfusion_latentnorm \
  mode=train \
  ...
  model=dfot_pushshapes_image_spatial_continuous \
