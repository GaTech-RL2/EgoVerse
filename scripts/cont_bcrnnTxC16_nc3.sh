...
# ---- GENTLE-TAIL CONTINUATION of bcrnnTxC16_nc3 ----
...
ORIG=/coc/flash7/paphiwetsa3/projects/EgoVerse2/logs/bcrnnTxC16_nc3/bc_rnn_tx_chunk16_2026-06-06_15-51-17
INIT_CKPT=$ORIG/checkpoints/epoch_epoch=1299.ckpt
NORM=$ORIG/norm_stats/norm_stats.json

NAME=bcrnnTxC16_nc3_cont
DESC=bc_rnn_tx_chunk16_cont
