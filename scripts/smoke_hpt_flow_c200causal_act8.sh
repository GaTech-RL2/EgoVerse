#!/bin/bash
#SBATCH --job-name=hptFlowC200CausalAct8Smoke
...
NAME=hptFlowC200CausalAct8Smoke
NORM=/coc/flash7/paphiwetsa3/projects/EgoVerse2/logs/hptFlowC200Causal_pushshapesPaper/hpt_flow_pushshapes_paper_causal_obs1_act32_2026-06-13_06-03-25/norm_stats/norm_stats.json
...
srun python -m egomimic.trainHydra \
  ...
  name=${NAME} description=hpt_flow_pushshapes_paper_causal_obs1_act8 mode=train \
