...
#SBATCH --requeue
#SBATCH --output=/coc/flash7/paphiwetsa3/projects/EgoVerse2/logs/genlvl40/%x_%A_%a.out
#SBATCH --error=/coc/flash7/paphiwetsa3/projects/EgoVerse2/logs/genlvl40/%x_%A_%a.err
set -uo pipefail
...
VID=logs/genlvl40_vids/${CELL}/lvl${LVL}; mkdir -p "$VID"; export ROLLOUT_VIDEO_DIR=$VID
