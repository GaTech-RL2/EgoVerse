...
# ---- GENTLE-TAIL CONTINUATION of bcrnnTxC4Q_nc3 ----
...
ORIG=/coc/flash7/paphiwetsa3/projects/EgoVerse2/logs/bcrnnTxC4Q_nc3/bc_rnn_tx_chunk4_queries_2026-06-06_16-24-59
INIT_CKPT=$ORIG/checkpoints/epoch_epoch=1199.ckpt
NORM=$ORIG/norm_stats/norm_stats.json

NAME=bcrnnTxC4Q_nc3_cont
DESC=bc_rnn_tx_chunk4_queries_cont
