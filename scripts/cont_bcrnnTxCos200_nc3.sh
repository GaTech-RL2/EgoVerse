...
# ---- GENTLE-TAIL CONTINUATION of bcrnnTxCos200_nc3 ----
...
ORIG=/coc/flash7/paphiwetsa3/projects/EgoVerse2/logs/bcrnnTxCos200_nc3/bc_rnn_tx_cos_200ep_2026-06-06_16-22-19
INIT_CKPT=$ORIG/checkpoints/epoch_epoch=1799.ckpt
NORM=$ORIG/norm_stats/norm_stats.json

NAME=bcrnnTxCos200_nc3_cont
DESC=bc_rnn_tx_cos_200ep_cont
