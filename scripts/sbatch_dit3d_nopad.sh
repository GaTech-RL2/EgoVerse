...
#SBATCH --qos=short
#SBATCH --no-requeue
#SBATCH --output=/coc/flash7/paphiwetsa3/projects/EgoVerse-pact/logs/sbatch/dit3d_nopad_%j.out
#SBATCH --error=/coc/flash7/paphiwetsa3/projects/EgoVerse-pact/logs/sbatch/dit3d_nopad_%j.err
...
srun --kill-on-bad-exit=1 .venv/bin/python -m egomimic.trainHydra \
  ...
  name=dit3d_nopad description=dit3d_nopad_addfusion_sigmoid \
  mode=train \
  ...
  model=dfot_pushshapes_image_spatial_cont_sigmoid \
