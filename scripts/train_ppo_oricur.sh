...
SNAP=/coc/flash7/paphiwetsa3/fpo_snapshots/gmmBC_oricur_bootstrap.ckpt
if [ ! -f "$SNAP" ]; then cp "$CKPT_SRC" "$SNAP"; echo "snapshotted $CKPT_SRC -> $SNAP"; fi

OUT=/coc/flash7/paphiwetsa3/projects/EgoVerse2/logs/ppoGMM_oricur
mkdir -p "$OUT"
