...
# ---- GENTLE-TAIL CONTINUATION of bcrnnHnetC8_nc3 ----
...
ORIG=/coc/flash7/paphiwetsa3/projects/EgoVerse2/logs/bcrnnHnetC8_nc3/bc_rnn_hnet_chunk8_2026-06-06_19-38-16
INIT_CKPT=$ORIG/checkpoints/epoch_epoch=1299.ckpt
NORM=$ORIG/norm_stats/norm_stats.json

NAME=bcrnnHnetC8_nc3_cont
DESC=bc_rnn_hnet_chunk8_cont
EPOCHS=1800; VALEVERY=100; LTB=50; MAXSTEPS=400

# ---- REQUEUE-SAFE checkpoint selection ----
# Recovery ckpt: the newest last.ckpt found at relaunch time (epoch 1399).
RECOVERY_CKPT=/coc/flash7/paphiwetsa3/projects/EgoVerse2/logs/bcrnnHnetC8_nc3_cont/bc_rnn_hnet_chunk8_cont_2026-06-08_23-12-12/checkpoints/last.ckpt
