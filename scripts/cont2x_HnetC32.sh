#!/bin/bash
#SBATCH --job-name=bcrnnHnetC32FHx2
...
# ---- CONT-2x of bcrnnHnetC32FH_nc3 (weights-only init + fresh productive warmup-cosine) ----
INIT_CKPT=/coc/flash7/paphiwetsa3/projects/EgoVerse2/logs/bcrnnHnetC32FH_nc3/bc_rnn_hnet_chunk32_fullhist_2026-06-10_01-44-49/checkpoints/epoch_epoch=599.ckpt
NORM=/coc/flash7/paphiwetsa3/projects/EgoVerse2/logs/bcrnnHnetC32FH_nc3/bc_rnn_hnet_chunk32_fullhist_2026-06-10_01-44-49/norm_stats/norm_stats.json
NAME=bcrnnHnetC32FH_nc3_cont2x
DESC=bc_rnn_hnet_chunk32_fullhist_cont2x
EPOCHS=${EPOCHS:-1800}; VALEVERY=100; LTB=50; MAXSTEPS=400
MAXSTEPS_SCHED=$(( EPOCHS * LTB ))   # fresh cosine horizon = new epochs x LTB
EXTRA_ARGS="model.robomimic_model.rnn_horizon=20 model.robomimic_model.core_net.max_window=20"   # per-run hydra overrides (rnn_horizon / window_anchor)
