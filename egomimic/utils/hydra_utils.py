...
def load_config(
    ...
    For config group paths (e.g. "data/pick_place/multiview_cartesian/eva_human_language"), the returned
    DictConfig contains the group contents directly (not nested under
    the group key).

    Args:
        config_name: Name of the config file (without .yaml extension).
            Can also be a config group path like "data/pick_place/multiview_cartesian/eva_human_language".
        overrides: Optional list of Hydra overrides (e.g. ["+trainer=ddp/debug"]).
