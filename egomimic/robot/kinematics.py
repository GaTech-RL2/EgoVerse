...
class MinkKinematicsSolver:
    ...
    mink's optimization-based IK instead of TracIK.
    ...
    def __init__(
        ...
        if velocity_limits is None:
            velocity_limits = {name: 1.0 for name in joint_names}
    ...
    def _resolve_model_path(self, model_path: str) -> str:
        """Resolve XML path, handling package:// URIs if present."""
    ...
    def ik(self, pos_xyz, rot_mat, cur_jnts, dt=0.01):
        """
        ...
        # Did not converge - return None or best solution
        # You can choose to return the best solution or None
        return self.configuration.q[self.dof_ids]
