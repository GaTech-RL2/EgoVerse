...
class ActionChunkCoordinateFrameTransform(Transform):
    ...
    def transform(self, batch):
        ...
        target_world_to_matrix_fn = _xyzwxyz_to_matrix if target_world.shape[-1] == 7 else _xyzypr_to_matrix
        # Convert to SE3 for transformation
        target_se3 = SE3.from_matrix(target_world_to_matrix_fn(target_world[None, :])[0])  # (4, 4)
