...
from egomimic.rldb.zarr.zarr_utils import ZarrEpisode, ZarrDataset
from egomimic.rldb.zarr.conversion_utils import EvaHD5Extractor
...
def convert_hdf5_to_zarr(
    ...
    if arm == "both":
        ...
        robot_type = "eva_left_arm"
    elif arm == "right":
        robot_type = "eva_right_arm"
    else:
        robot_type = "eva"
    ...
    try:
        zarr_path = ZarrWriter.create_and_write(
            ...
            task="",  # Task description can be added if available
        )
