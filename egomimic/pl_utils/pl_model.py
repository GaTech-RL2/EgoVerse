...
class ModelWrapper(LightningModule):
    ...
    def _backbone_param_groups(self, lr: float, scale: float):
        ...
        want the same learning rate, and a frozen-vs-tuned or a
        ResNet-vs-SigLIP comparison under one LR is confounded. Encoders that
        do not declare ``backbone_parameters`` (and frozen parameters) are left
        to the main group.
        """
