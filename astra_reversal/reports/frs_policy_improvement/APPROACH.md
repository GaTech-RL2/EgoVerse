...
The [bridge](../../lerobot_policy.py) calls the existing LeRobot model's velocity field and exposes its sampling noise. It loads the pinned checkpoint tensors directly. The auxiliary noise actor described below is a separate experiment component.
