...
# Pull Teleop Round v3 (72-demo pickplace). Primary = epoch 1999.
#
# Usage:
#   bash pull_teleop_pp_0724_v3.sh
#   EPOCHS="599 1999" bash pull_teleop_pp_0724_v3.sh
#   SKYNET_PASS=... bash pull_teleop_pp_0724_v3.sh
...
RUN_REL="logs/RBY1_wb_img_tel_v3/wb_img_pickplace_v3_72demo_2k/checkpoints"
LOCAL_CKPT_DIR="./checkpoints/RBY1_wb_img_tel_v3/wb_img_pickplace_v3_72demo_2k/checkpoints"
EPOCHS="${EPOCHS:-1999 599}"
