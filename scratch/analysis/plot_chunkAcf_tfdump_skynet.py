...
D = "/coc/flash7/paphiwetsa3/projects/EgoVerse2/logs/tf_dump_chunkAcf_obsonly"
...
fig.suptitle(
    "chunk-A CURRENT-FRAME (teacher-forcing, consistent) -- GT demo (green) vs pred (red)\n"
    "reactive+chunk_k=32, train (forward_packed T=1) == generate; epoch-199 checkpoint",
    fontsize=13)
fig.tight_layout(rect=[0, 0, 1, 0.96])
out = f"{D}/chunkA_cf_tf_obsonly_gt_vs_pred.png"
