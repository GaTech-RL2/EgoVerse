...
D = "/coc/flash7/paphiwetsa3/projects/EgoVerse2/logs/tf_dump_chunkB_obsonly"
...
fig.suptitle(
    "chunk-B (AR / closed-loop, teacher-forced overlay, OBS-ONLY) -- GT demo (green) vs pred (red)\n"
    "consistent: T=1 training == generate; epoch-199 checkpoint",
    fontsize=13)
fig.tight_layout(rect=[0, 0, 1, 0.96])
out = f"{D}/chunkB_tf_obsonly_gt_vs_pred.png"
