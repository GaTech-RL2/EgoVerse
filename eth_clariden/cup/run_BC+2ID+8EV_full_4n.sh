#!/bin/bash
#SBATCH --job-name=eve_cup_BC2ID8EV_4n4g_full
#SBATCH --account=cvg-prof-m-2
#SBATCH --output=/iopsstor/scratch/cscs/jiaqchen/egomim_out/main/cup/full_4n/slurm-cup-BC2ID8EV-4n-%j.out
#SBATCH --error=/iopsstor/scratch/cscs/jiaqchen/egomim_out/main/cup/full_4n/slurm-cup-BC2ID8EV-4n-%j.err
...
############################################################
# Cup BC+2ID+8EV (full mix): indomain + 4 EgoVerse labs (rl2, song, wang, eth).
...
export RUN_NAME="${RUN_NAME:-cup_BC_2ID_8EV_4n4g_full}"
...
echo "============================================================"
echo "[cup BC+2ID+8EV FULL 4n4g] 2000-epoch full mix, 16 GPUs"
