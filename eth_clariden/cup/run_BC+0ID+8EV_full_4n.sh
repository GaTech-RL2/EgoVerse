#!/bin/bash
#SBATCH --job-name=eve_cup_BC0ID8EV_4n4g_full
#SBATCH --account=cvg-prof-m-2
#SBATCH --output=/iopsstor/scratch/cscs/jiaqchen/egomim_out/main/cup/full_4n/slurm-cup-BC0ID8EV-4n-%j.out
#SBATCH --error=/iopsstor/scratch/cscs/jiaqchen/egomim_out/main/cup/full_4n/slurm-cup-BC0ID8EV-4n-%j.err
...
############################################################
# Cup BC+0ID+8EV: BC + 4 EgoVerse Aria labs (rl2, song, wang, eth). No indomain.
...
export VARIANT="${VARIANT:-BC+0ID+8EV}"
export RUN_NAME="${RUN_NAME:-cup_BC_0ID_8EV_4n4g_full}"
...
echo "============================================================"
echo "[cup BC+0ID+8EV FULL 4n4g] EgoVerse-main 2000-epoch BC+0ID+8EV, 16 GPUs"
