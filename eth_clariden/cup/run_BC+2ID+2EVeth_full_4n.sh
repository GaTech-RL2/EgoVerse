#!/bin/bash
#SBATCH --job-name=eve_cup_BC2ID2EVeth_4n4g_full
#SBATCH --account=cvg-prof-m-2
#SBATCH --output=/iopsstor/scratch/cscs/jiaqchen/egomim_out/main/cup/full_4n/slurm-cup-BC2ID2EVeth-4n-%j.out
#SBATCH --error=/iopsstor/scratch/cscs/jiaqchen/egomim_out/main/cup/full_4n/slurm-cup-BC2ID2EVeth-4n-%j.err
...
############################################################
# Cup BC+2ID+2EVeth: BC + indomain (eth) + everse_eth. ETH-only Aria.
...
export VARIANT="${VARIANT:-BC+2ID+2EVeth}"
export RUN_NAME="${RUN_NAME:-cup_BC_2ID_2EVeth_4n4g_full}"
...
echo "============================================================"
echo "[cup BC+2ID+2EVeth FULL 4n4g] 2000-epoch, 16 GPUs"
