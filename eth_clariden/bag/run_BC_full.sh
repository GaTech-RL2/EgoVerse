...
export RUN_NAME="${RUN_NAME:-bag_BC_pg4_full_${SLURM_JOB_ID}}"
...
export HYDRA_RUN_DIR=${HYDRA_RUN_DIR:-/iopsstor/scratch/cscs/jiaqchen/egomim_out/main/FULL/eve_bag_bc/${RUN_NAME}}
mkdir -p "${HYDRA_RUN_DIR}" "$(dirname /iopsstor/scratch/cscs/jiaqchen/egomim_out/main/bag/full/.)"

echo "============================================================"
echo "[bag BC FULL] EgoVerse-main 2000-epoch BC pipeline"
echo "  RUN_NAME=${RUN_NAME}"
echo "  EVE_LOCAL_ZARR_DIR=${EVE_LOCAL_ZARR_DIR}"
echo "  HYDRA_RUN_DIR=${HYDRA_RUN_DIR}"
echo "  WANDB_RUN_ID=${WANDB_RUN_ID}"
echo "  Resume on requeue: SLURM_RESTART_COUNT=${SLURM_RESTART_COUNT:-0}"
echo "============================================================"

# Detect existing checkpoint for auto-resume across requeues.
