...
/coc/flash7/paphiwetsa3/projects/EgoVerse2/.venv/bin/python -m egomimic.trainHydra \
  name=hptFlowC3000Causal_eval_rollout \
  description=eval_hpt_flow_circle_3000_causal \
  mode=eval \
  ckpt_path=/coc/flash7/paphiwetsa3/projects/EgoVerse2/logs/hptFlowC3000Causal/hpt_flow_circle_3000_causal_obs1_act32_2026-06-13_03-08-51/checkpoints/epoch_epoch=1399.ckpt \
